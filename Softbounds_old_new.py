...
# old softbounds table copied from AAchoose_bounds_app.py. Product fixed to 'Lf L' and Year to 2024.
# Adapted to include herd_group column set to "any" for general rules (matches existing fallback logic)
_old_softbounds_rows = [
    # --- attrition_rate (formerly exit_rate) ---
    ("attrition_rate","schwarzbunt","Lf L",2024,"Conventional","any",0.15,0.42),
    ("attrition_rate","fleckvieh","Lf L",2024,"Conventional","any",0.15,0.42),
    ("attrition_rate","braunvieh","Lf L",2024,"Conventional","any",0.15,0.42),
    ("attrition_rate","schwarzbunt","Lf L",2024,"Organic","any",0.117,0.328),
    ("attrition_rate","fleckvieh","Lf L",2024,"Organic","any",0.122,0.344),
    ("attrition_rate","braunvieh","Lf L",2024,"Organic","any",0.121,0.34),

    # --- calf_loss_rate ---
    ("calf_loss_rate","fleckvieh","Lf L",2024,"Organic","any",0.02,0.145),
    ("calf_loss_rate","braunvieh","Lf L",2024,"Organic","any",0.029,0.165),
    ("calf_loss_rate","schwarzbunt","Lf L",2024,"Conventional","any",0.041,0.18),
    ("calf_loss_rate","fleckvieh","Lf L",2024,"Conventional","any",0.02,0.14),
    ("calf_loss_rate","braunvieh","Lf L",2024,"Conventional","any",0.03,0.17),
    ("calf_loss_rate","schwarzbunt","Lf L",2024,"Organic","any",0.037,0.164),

    # --- fat_content ---
    ("fat_content","schwarzbunt","Lf L",2024,"Conventional","any",0.037,0.047),
    ("fat_content","fleckvieh","Lf L",2024,"Conventional","any",0.037,0.047),
    ("fat_content","braunvieh","Lf L",2024,"Conventional","any",0.037,0.047),
    ("fat_content","schwarzbunt","Lf L",2024,"Organic","any",0.036,0.048),
    ("fat_content","fleckvieh","Lf L",2024,"Organic","any",0.036,0.046),
    ("fat_content","braunvieh","Lf L",2024,"Organic","any",0.036,0.046),

    # --- first_calving_age ---
    ("first_calving_age","schwarzbunt","Lf L",2024,"Conventional","any",21,33),
    ("first_calving_age","fleckvieh","Lf L",2024,"Conventional","any",23,35),
    ...
    # --- gutting_rate ---
    ("gutting_rate","schwarzbunt","Lf L",2024,"Conventional","any",0.27,0.59),
    ("gutting_rate","fleckvieh","Lf L",2024,"Conventional","any",0.287,0.622),
    ("gutting_rate","braunvieh","Lf L",2024,"Conventional","any",0.266,0.576),
    ("gutting_rate","schwarzbunt","Lf L",2024,"Organic","any",0.27,0.59),
    ("gutting_rate","fleckvieh","Lf L",2024,"Organic","any",0.287,0.622),
    ("gutting_rate","braunvieh","Lf L",2024,"Organic","any",0.266,0.576),

    # --- intercalving_period ---
    ("intercalving_period","schwarzbunt","Lf L",2024,"Conventional","any",386,446),
    ("intercalving_period","fleckvieh","Lf L",2024,"Conventional","any",364,424),
    ("intercalving_period","braunvieh","Lf L",2024,"Conventional","any",389,449),
    ("intercalving_period","schwarzbunt","Lf L",2024,"Organic","any",382,442),
    ("intercalving_period","fleckvieh","Lf L",2024,"Organic","any",363,423),
    ("intercalving_period","braunvieh","Lf L",2024,"Organic","any",384,444),

    # --- live_weight ---
    ("live_weight","schwarzbunt","Lf L",2024,"Conventional","any",600,742),
    ("live_weight","fleckvieh","Lf L",2024,"Conventional","any",650,800),
    ("live_weight","braunvieh","Lf L",2024,"Conventional","any",600,742),
    ("live_weight","schwarzbunt","Lf L",2024,"Organic","any",600,742),
    ("live_weight","fleckvieh","Lf L",2024,"Organic","any",650,800),
    ("live_weight","braunvieh","Lf L",2024,"Organic","any",600,742),

    # --- loss_rate (small values; unchanged) ---
    ("loss_rate","schwarzbunt","Lf L",2024,"Conventional","any",0.029,0.079),
    ("loss_rate","fleckvieh","Lf L",2024,"Conventional","any",0.003,0.053),
    ("loss_rate","braunvieh","Lf L",2024,"Conventional","any",0.01,0.06),
    ("loss_rate","schwarzbunt","Lf L",2024,"Organic","any",0.024,0.066),
    ("loss_rate","fleckvieh","Lf L",2024,"Organic","any",0.002,0.036),
    ("loss_rate","braunvieh","Lf L",2024,"Organic","any",0.007,0.045),

    # --- milk_yield ---
    ("milk_yield","schwarzbunt","Lf L",2024,"Conventional","any",5910,12940),
    ("milk_yield","fleckvieh","Lf L",2024,"Conventional","any",4470,11500),
    ("milk_yield","braunvieh","Lf L",2024,"Conventional","any",4040,12000),
    ("milk_yield","schwarzbunt","Lf L",2024,"Organic","any",5910,12940),
    ("milk_yield","fleckvieh","Lf L",2024,"Organic","any",4470,11500),
    ("milk_yield","braunvieh","Lf L",2024,"Organic","any",4040,12000),

    # --- protein_content ---
    ("protein_content","schwarzbunt","Lf L",2024,"Conventional","any",0.03,0.039),
    ("protein_content","fleckvieh","Lf L",2024,"Conventional","any",0.03,0.039),
    ("protein_content","braunvieh","Lf L",2024,"Conventional","any",0.03,0.039),
    ("protein_content","schwarzbunt","Lf L",2024,"Organic","any",0.029,0.038),
    ("protein_content","fleckvieh","Lf L",2024,"Organic","any",0.028,0.037),
    ("protein_content","braunvieh","Lf L",2024,"Organic","any",0.029,0.038),

    # --- slaughter_weight ---
    ("slaughter_weight","schwarzbunt","Lf L",2024,"Conventional","any",250,339),
    ("slaughter_weight","fleckvieh","Lf L",2024,"Conventional","any",299,389),
    ("slaughter_weight","braunvieh","Lf L",2024,"Conventional","any",261,351),
    ("slaughter_weight","schwarzbunt","Lf L",2024,"Organic","any",250,339),
    ("slaughter_weight","fleckvieh","Lf L",2024,"Organic","any",299,389),
    ("slaughter_weight","braunvieh","Lf L",2024,"Organic","any",261,351),

    # --- weaning_age ---
    ("weaning_age","schwarzbunt","Lf L",2024,"Conventional","any",4,12),
    ("weaning_age","fleckvieh","Lf L",2024,"Conventional","any",4,12),
    ("weaning_age","braunvieh","Lf L",2024,"Conventional","any",4,12),
    ("weaning_age","schwarzbunt","Lf L",2024,"Organic","any",6,18),
    ("weaning_age","fleckvieh","Lf L",2024,"Organic","any",6,18),
    ("weaning_age","braunvieh","Lf L",2024,"Organic","any",6,18),
]

OLD_SOFTBOUNDS = pd.DataFrame(_old_softbounds_rows, columns=[
    "datapoint","breed","product","year","farming_method","herd_group","soft_min","soft_max"
])

# NEW Softbounds table (hardcoded) - more detailed with herd-specific bounds
_new_softbounds_rows = [
...
NEW_SOFTBOUNDS_HARDCODED = pd.DataFrame(_new_softbounds_rows, columns=[
    "datapoint","breed","product","year","farming_method","herd_group","soft_min","soft_max"
])

# Use hardcoded NEW softbounds by default
NEW_SOFTBOUNDS = NEW_SOFTBOUNDS_HARDCODED.copy()
NEW_SOFTBOUNDS_LOADED = True
NEW_SOFTBOUNDS_SOURCE = "hardcoded"

# Optionally try to load NEW softbounds from CSV file (will override hardcoded if available)
try:
    softbounds_csv_path = "Soft bounds new - Sheet1.csv"
    new_softbounds_df = pd.read_csv(softbounds_csv_path)
    # Add product and year columns to match expected structure
    new_softbounds_df["product"] = "Lf L"
    new_softbounds_df["year"] = 2024
    # Reorder columns to match expected structure
    NEW_SOFTBOUNDS = new_softbounds_df[["datapoint","breed","product","year","farming_method","herd_group","soft_min","soft_max"]]
    NEW_SOFTBOUNDS_SOURCE = "CSV file"
except Exception as e:
    # Use hardcoded version (already set above)
    pass

# Keep SOFTBOUNDS as OLD_SOFTBOUNDS for backward compatibility with existing code
SOFTBOUNDS = OLD_SOFTBOUNDS
...
# Display softbounds loading status
st.sidebar.markdown("### Softbounds Status")
st.sidebar.success(f"✅ old softbounds: {len(OLD_SOFTBOUNDS)} rules loaded (from AAchoose_bounds_app.py)")
if NEW_SOFTBOUNDS_LOADED:
    st.sidebar.success(f"✅ NEW Softbounds: {len(NEW_SOFTBOUNDS)} rules loaded ({NEW_SOFTBOUNDS_SOURCE})")
else:
    st.sidebar.error("❌ NEW Softbounds: Failed to load")
...
with col_f1:
    ...
    dp_label = st.selectbox("Datapoint", list(dp_map.keys()), index=2)  # Default to "Milk yield"
...
with col_f4:
    ...
    show_old_softbounds = st.checkbox("Show old softbounds", value=True)
    show_new_softbounds = st.checkbox("Show NEW softbounds (detailed herd-specific)", value=False)
    show_strict_bounds = st.checkbox("Show adjusted bounds (range-based)", value=False)
            ...
            for idx_col, hg_name in enumerate(row_hgs):
                with cols[idx_col]:
                    ...
                    if N > 0:
                        ...
                        # Note: X-axis range will be set at the end after all traces are added
                        ...
                        # old softbounds for this fm/breed/herd_group (year 2024). Use milk_yield for adjusted
                        if show_old_softbounds:
                            dp_soft = "milk_yield" if dp_col == "milk_yield_adjusted" else dp_col
                            # Try herd-specific bounds first, then fall back to "any"
                            sb_specific = OLD_SOFTBOUNDS[(OLD_SOFTBOUNDS["datapoint"]==dp_soft) & (OLD_SOFTBOUNDS["breed"]==breed) & 
                                                    (OLD_SOFTBOUNDS["year"]==2024) & (OLD_SOFTBOUNDS["farming_method"]==fm) & 
                                                    (OLD_SOFTBOUNDS["herd_group"]==hg_name)]
                            sb_any = OLD_SOFTBOUNDS[(OLD_SOFTBOUNDS["datapoint"]==dp_soft) & (OLD_SOFTBOUNDS["breed"]==breed) & 
                                               (OLD_SOFTBOUNDS["year"]==2024) & (OLD_SOFTBOUNDS["farming_method"]==fm) & 
                                               (OLD_SOFTBOUNDS["herd_group"]=="any")]
                            ...
                            if not sb_subset.empty:
                                ...
                                fig.add_trace(go.Scatter(x=[smin, smin], y=vline_y, mode='lines', name=f"old softbound min{hg_label} = {smin:.3f}", line=dict(color='orange', width=2, dash='dash'), hoverinfo='skip'))
                                fig.add_trace(go.Scatter(x=[smax, smax], y=vline_y, mode='lines', name=f"old softbound max{hg_label} = {smax:.3f}", line=dict(color='orange', width=2, dash='dash'), hoverinfo='skip'))
                                
                                # Adjusted bounds for OLD: narrow (positive %) or broaden (negative %) the range
                                if show_strict_bounds and strict_pct != 0:
                                    ...
                                    if strict_min < strict_max:  # Only show if bounds are valid
                                        ...
                                        fig.add_trace(go.Scatter(x=[strict_min, strict_min], y=vline_y, mode='lines', 
                                                                name=f"old adjusted min{hg_label} ({direction_label}) = {strict_min:.3f}", 
                                        ...
                                        fig.add_trace(go.Scatter(x=[strict_max, strict_max], y=vline_y, mode='lines', 
                                                                name=f"old adjusted max{hg_label} ({direction_label}) = {strict_max:.3f}", 
                                                                line=dict(color='crimson', width=2, dash='dashdot'), hoverinfo='skip'))
                                
                                # Multiplicative bounds for OLD: multiply each bound by (1±%)
                                if show_multiplicative_bounds and mult_pct > 0:
                                    ...
                                    fig.add_trace(go.Scatter(x=[mult_min, mult_min], y=vline_y, mode='lines',
                                                            name=f"old mult. min{hg_label} (×{1-mult_pct/100:.2f}) = {mult_min:.3f}",
                                    ...
                                    fig.add_trace(go.Scatter(x=[mult_max, mult_max], y=vline_y, mode='lines',
                                                            name=f"old mult. max{hg_label} (×{1+mult_pct/100:.2f}) = {mult_max:.3f}",
                                                            line=dict(color='darkviolet', width=2, dash='longdashdot'), hoverinfo='skip'))
                                
                        # NEW Softbounds from CSV for this fm/breed/herd_group (year 2024). Use milk_yield for adjusted
                        if show_new_softbounds:
                            dp_soft = "milk_yield" if dp_col == "milk_yield_adjusted" else dp_col
                            # Try herd-specific bounds first, then fall back to "any"
                            sb_specific = NEW_SOFTBOUNDS[(NEW_SOFTBOUNDS["datapoint"]==dp_soft) & (NEW_SOFTBOUNDS["breed"]==breed) & 
                                                    (NEW_SOFTBOUNDS["year"]==2024) & (NEW_SOFTBOUNDS["farming_method"]==fm) & 
                                                    (NEW_SOFTBOUNDS["herd_group"]==hg_name)]
                            sb_any = NEW_SOFTBOUNDS[(NEW_SOFTBOUNDS["datapoint"]==dp_soft) & (NEW_SOFTBOUNDS["breed"]==breed) & 
                                               (NEW_SOFTBOUNDS["year"]==2024) & (NEW_SOFTBOUNDS["farming_method"]==fm) & 
                                               (NEW_SOFTBOUNDS["herd_group"]=="any")]
                            sb_subset_new = sb_specific if not sb_specific.empty else sb_any
                            if not sb_subset_new.empty:
                                smin_new = float(sb_subset_new["soft_min"].min())
                                smax_new = float(sb_subset_new["soft_max"].max())
                                hg_label_new = f" ({hg_name})" if not sb_specific.empty and hg_name != "All" else ""
                                fig.add_trace(go.Scatter(x=[smin_new, smin_new], y=vline_y, mode='lines', name=f"NEW Softbound min{hg_label_new} = {smin_new:.3f}", line=dict(color='blue', width=2, dash='dot'), hoverinfo='skip'))
                                fig.add_trace(go.Scatter(x=[smax_new, smax_new], y=vline_y, mode='lines', name=f"NEW Softbound max{hg_label_new} = {smax_new:.3f}", line=dict(color='blue', width=2, dash='dot'), hoverinfo='skip'))
                                
                                # Adjusted bounds for NEW: narrow (positive %) or broaden (negative %) the range
                                if show_strict_bounds and strict_pct != 0:
                                    sb_range_new = smax_new - smin_new
                                    adjustment_new = sb_range_new * (strict_pct / 100.0)
                                    strict_min_new = smin_new + adjustment_new
                                    strict_max_new = smax_new - adjustment_new
                                    if strict_min_new < strict_max_new:  # Only show if bounds are valid
                                        direction_label_new = f"{'+' if strict_pct > 0 else ''}{strict_pct:.0f}%"
                                        fig.add_trace(go.Scatter(x=[strict_min_new, strict_min_new], y=vline_y, mode='lines', 
                                                                name=f"NEW Adjusted min{hg_label_new} ({direction_label_new}) = {strict_min_new:.3f}", 
                                                                line=dict(color='green', width=2, dash='dashdot'), hoverinfo='skip'))
                                        fig.add_trace(go.Scatter(x=[strict_max_new, strict_max_new], y=vline_y, mode='lines', 
                                                                name=f"NEW Adjusted max{hg_label_new} ({direction_label_new}) = {strict_max_new:.3f}", 
                                                                line=dict(color='green', width=2, dash='dashdot'), hoverinfo='skip'))
                                
                                # Multiplicative bounds for NEW: multiply each bound by (1±%)
                                if show_multiplicative_bounds and mult_pct > 0:
                                    mult_min_new = smin_new * (1 - mult_pct / 100.0)
                                    mult_max_new = smax_new * (1 + mult_pct / 100.0)
                                    fig.add_trace(go.Scatter(x=[mult_min_new, mult_min_new], y=vline_y, mode='lines',
                                                            name=f"NEW Mult. min{hg_label_new} (×{1-mult_pct/100:.2f}) = {mult_min_new:.3f}",
                                                            line=dict(color='purple', width=2, dash='longdashdot'), hoverinfo='skip'))
                                    fig.add_trace(go.Scatter(x=[mult_max_new, mult_max_new], y=vline_y, mode='lines',
                                                            name=f"NEW Mult. max{hg_label_new} (×{1+mult_pct/100:.2f}) = {mult_max_new:.3f}",
                                                            line=dict(color='purple', width=2, dash='longdashdot'), hoverinfo='skip'))
                        ...
                        # Calculate x-axis range to include all relevant values
                        if use_xrange and x_min_all is not None and x_max_all is not None and x_max_all > x_min_all:
                            # User specified custom range
                            fig.update_xaxes(range=[x_min_all, x_max_all])
                        else:
                            # Auto-range: collect all x-values that should be visible
                            x_values_to_include = []
                            if N > 0:
                                x_values_to_include.extend([float(np.min(x)), float(np.max(x))])
                            
                            # Include OLD softbounds if shown (including adjusted and multiplicative)
                            if show_old_softbounds:
                                dp_soft = "milk_yield" if dp_col == "milk_yield_adjusted" else dp_col
                                sb_specific = OLD_SOFTBOUNDS[(OLD_SOFTBOUNDS["datapoint"]==dp_soft) & (OLD_SOFTBOUNDS["breed"]==breed) & 
                                                        (OLD_SOFTBOUNDS["year"]==2024) & (OLD_SOFTBOUNDS["farming_method"]==fm) & 
                                ...
                                sb_subset = sb_specific if not sb_specific.empty else sb_any
                                if not sb_subset.empty:
                                    smin_old = float(sb_subset["soft_min"].min())
                                    smax_old = float(sb_subset["soft_max"].max())
                                    x_values_to_include.extend([smin_old, smax_old])
                                    
                                    # Include adjusted bounds if shown
                                    if show_strict_bounds and strict_pct != 0:
                                        sb_range = smax_old - smin_old
                                        adjustment = sb_range * (strict_pct / 100.0)
                                        strict_min = smin_old + adjustment
                                        strict_max = smax_old - adjustment
                                        if strict_min < strict_max:
                                            x_values_to_include.extend([strict_min, strict_max])
                                    
                                    # Include multiplicative bounds if shown
                                    if show_multiplicative_bounds and mult_pct > 0:
                                        mult_min = smin_old * (1 - mult_pct / 100.0)
                                        mult_max = smax_old * (1 + mult_pct / 100.0)
                                        x_values_to_include.extend([mult_min, mult_max])
                            
                            # Include NEW softbounds if shown (including adjusted and multiplicative)
                            if show_new_softbounds:
                                dp_soft = "milk_yield" if dp_col == "milk_yield_adjusted" else dp_col
                                sb_specific = NEW_SOFTBOUNDS[(NEW_SOFTBOUNDS["datapoint"]==dp_soft) & (NEW_SOFTBOUNDS["breed"]==breed) & 
                                                        (NEW_SOFTBOUNDS["year"]==2024) & (NEW_SOFTBOUNDS["farming_method"]==fm) & 
                                ...
                                if not sb_subset_new.empty:
                                    smin_new = float(sb_subset_new["soft_min"].min())
                                    smax_new = float(sb_subset_new["soft_max"].max())
                                    x_values_to_include.extend([smin_new, smax_new])
                                    ...
                                    if show_strict_bounds and strict_pct != 0:
                                        ...
                                        strict_min_new = smin_new + adjustment_new
                                        strict_max_new = smax_new - adjustment_new
                                        if strict_min_new < strict_max_new:
                                            x_values_to_include.extend([strict_min_new, strict_max_new])
                                    
                                    # Include multiplicative bounds if shown
                                    if show_multiplicative_bounds and mult_pct > 0:
                                        mult_min_new = smin_new * (1 - mult_pct / 100.0)
                                        mult_max_new = smax_new * (1 + mult_pct / 100.0)
                                        x_values_to_include.extend([mult_min_new, mult_max_new])
                            
                            # Store the range for later application (after update_layout)
                            x_axis_range = None
                            if x_values_to_include:
                                x_range_min = min(x_values_to_include)
                                x_range_max = max(x_values_to_include)
                                margin = (x_range_max - x_range_min) * 0.1  # 10% margin for better visibility
                                x_axis_range = [x_range_min - margin, x_range_max + margin]
                        ...
                        # Apply x-axis range AFTER update_layout to prevent it from being reset
                        ...
                        # old softbounds summary (year 2024) - herd-specific or "any"
                        if show_old_softbounds:
                            dp_soft = "milk_yield" if dp_col == "milk_yield_adjusted" else dp_col
                            # Try herd-specific bounds first, then fall back to "any"
                            sb_specific = OLD_SOFTBOUNDS[(OLD_SOFTBOUNDS["datapoint"]==dp_soft) & (OLD_SOFTBOUNDS["breed"]==breed) & 
                            ...
                            if not sb_subset.empty:
                                ...
                                hg_label = f" ({hg_name})" if not sb_specific.empty and hg_name != "All" else ""
                                stat_rows.extend([
                                    {"Metric": f"old softbounds eligible (2024{hg_label})", "Value": sb_eligible},
                                    {"Metric": "Outside old softbounds (below)", "Value": sb_below},
                                    {"Metric": "Outside old softbounds (above)", "Value": sb_above},
                                    {"Metric": "Outside old softbounds (total)", "Value": total_sb},
                                    {"Metric": "Outside old softbounds (%)", "Value": f"{pct_sb:.1f}%"},
                                ])
                                ...
                                if show_strict_bounds and strict_pct != 0:
                                    ...
                                    if strict_min < strict_max:
                                        ...
                                        direction_label = f"{'+' if strict_pct > 0 else ''}{strict_pct:.0f}%"
                                        stat_rows.extend([
                                            {"Metric": f"old adjusted bounds min ({direction_label})", "Value": round(strict_min, 3)},
                                            {"Metric": f"old adjusted bounds max ({direction_label})", "Value": round(strict_max, 3)},
                                            {"Metric": "Outside old adjusted bounds (below)", "Value": strict_below},
                                            {"Metric": "Outside old adjusted bounds (above)", "Value": strict_above},
                                            {"Metric": "Outside old adjusted bounds (total)", "Value": total_strict},
                                            {"Metric": "Outside old adjusted bounds (%)", "Value": f"{pct_strict:.1f}%"},
                                        ])
                                ...
                                if show_multiplicative_bounds and mult_pct > 0:
                                    ...
                                    stat_rows.extend([
                                        {"Metric": f"old multiplicative bounds min (×{1-mult_pct/100:.2f})", "Value": round(mult_min, 3)},
                                        {"Metric": f"old multiplicative bounds max (×{1+mult_pct/100:.2f})", "Value": round(mult_max, 3)},
                                        {"Metric": "Outside old multiplicative bounds (below)", "Value": mult_below},
                                        {"Metric": "Outside old multiplicative bounds (above)", "Value": mult_above},
                                        {"Metric": "Outside old multiplicative bounds (total)", "Value": total_mult},
                                        {"Metric": "Outside old multiplicative bounds (%)", "Value": f"{pct_mult:.1f}%"},
                                    ])
                        
                        # NEW Softbounds summary (year 2024) - herd-specific or "any"
                        if show_new_softbounds:
                            dp_soft = "milk_yield" if dp_col == "milk_yield_adjusted" else dp_col
                            # Try herd-specific bounds first, then fall back to "any"
                            sb_specific = NEW_SOFTBOUNDS[(NEW_SOFTBOUNDS["datapoint"]==dp_soft) & (NEW_SOFTBOUNDS["breed"]==breed) & 
                            ...
                            if not sb_subset_new.empty:
                                ...
                                smax_new = float(sb_subset_new["soft_max"].max())
                                vals = x  # already the dp_col subset values
                                sb_eligible_new = int(vals.shape[0])
                                sb_below_new = int(np.sum(vals < smin_new))
                                sb_above_new = int(np.sum(vals > smax_new))
                                total_sb_new = sb_below_new + sb_above_new
                                pct_sb_new = (total_sb_new / sb_eligible_new * 100) if sb_eligible_new > 0 else 0.0
                                hg_label_new = f" ({hg_name})" if not sb_specific.empty and hg_name != "All" else ""
                                stat_rows.extend([
                                    {"Metric": f"NEW Softbounds eligible (2024{hg_label_new})", "Value": sb_eligible_new},
                                    {"Metric": "Outside NEW softbounds (below)", "Value": sb_below_new},
                                    {"Metric": "Outside NEW softbounds (above)", "Value": sb_above_new},
                                    {"Metric": "Outside NEW softbounds (total)", "Value": total_sb_new},
                                    {"Metric": "Outside NEW softbounds (%)", "Value": f"{pct_sb_new:.1f}%"},
                                ])
                                ...
                                if show_strict_bounds and strict_pct != 0:
                                    ...
                                    strict_max_new = smax_new - adjustment_new
                                    if strict_min_new < strict_max_new:
                                        strict_below_new = int(np.sum(vals < strict_min_new))
                                        strict_above_new = int(np.sum(vals > strict_max_new))
                                        total_strict_new = strict_below_new + strict_above_new
                                        pct_strict_new = (total_strict_new / sb_eligible_new * 100) if sb_eligible_new > 0 else 0.0
                                        direction_label_new = f"{'+' if strict_pct > 0 else ''}{strict_pct:.0f}%"
                                        stat_rows.extend([
                                            {"Metric": f"NEW Adjusted bounds min ({direction_label_new})", "Value": round(strict_min_new, 3)},
                                            {"Metric": f"NEW Adjusted bounds max ({direction_label_new})", "Value": round(strict_max_new, 3)},
                                            {"Metric": "Outside NEW adjusted bounds (below)", "Value": strict_below_new},
                                            {"Metric": "Outside NEW adjusted bounds (above)", "Value": strict_above_new},
                                            {"Metric": "Outside NEW adjusted bounds (total)", "Value": total_strict_new},
                                            {"Metric": "Outside NEW adjusted bounds (%)", "Value": f"{pct_strict_new:.1f}%"},
                                        ])
                                ...
                                if show_multiplicative_bounds and mult_pct > 0:
                                    mult_min_new = smin_new * (1 - mult_pct / 100.0)
                                    mult_max_new = smax_new * (1 + mult_pct / 100.0)
                                    mult_below_new = int(np.sum(vals < mult_min_new))
                                    mult_above_new = int(np.sum(vals > mult_max_new))
                                    total_mult_new = mult_below_new + mult_above_new
                                    pct_mult_new = (total_mult_new / sb_eligible_new * 100) if sb_eligible_new > 0 else 0.0
                                    stat_rows.extend([
                                        {"Metric": f"NEW Multiplicative bounds min (×{1-mult_pct/100:.2f})", "Value": round(mult_min_new, 3)},
                                        {"Metric": f"NEW Multiplicative bounds max (×{1+mult_pct/100:.2f})", "Value": round(mult_max_new, 3)},
                                        {"Metric": "Outside NEW multiplicative bounds (below)", "Value": mult_below_new},
                                        {"Metric": "Outside NEW multiplicative bounds (above)", "Value": mult_above_new},
                                        {"Metric": "Outside NEW multiplicative bounds (total)", "Value": total_mult_new},
                                        {"Metric": "Outside NEW multiplicative bounds (%)", "Value": f"{pct_mult_new:.1f}%"},
                                    ])

                        # Convert stat_rows to DataFrame and fix percentage strings for PyArrow compatibility
                        stat_df = pd.DataFrame(stat_rows)
                        # Convert percentage strings to numeric values
                        if not stat_df.empty:
                            stat_df['Value'] = stat_df['Value'].apply(
                                lambda v: float(str(v).rstrip('%')) if isinstance(v, str) and v.endswith('%') else v
                            )
